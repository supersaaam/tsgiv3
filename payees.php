  ...
  <div class="content-wrapper">
      ...
      <h1>
        ...
        <small>Records Management</small>
            ...
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Payee Records</li>
            </ol>
    </section>
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">
              <a href='javascript:void(0);' data-href='view_payee.php' id='addPayee'><button type='button' class='btn btn-success'><i class='fa fa-plus'></i> &nbsp;Add New Record</button></a>
              </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
if (isset($_GET['success'])) {
  ?>
    ...
    history.pushState(null, null, 'payee');
<?php
