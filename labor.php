              ...
              <!--START OF FIRST TABLE-->    
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <?php
                        ...
                        if($bom->get_labor($_GET['bom']) > 0){
                            $bom->show_labor($_GET['bom']);   
                        }
                        else{
                    ?>
                      ...
                      <tr id='tr1'>
                        ...
                        <td>
                          <input type="number" min='0' name='days[]' id='days1' style="text-align:right; background-color:transparent; border:transparent; width:100%" required class="form-control">
                        </td>
                        <td>
                          <input type="number" name='rate[]' id='rate1' style="text-align:right; background-color:transparent; border:transparent; width:100%" required step='any' min='0' class="form-control">
                        </td>
                        <td>
                    ...
                    <tfoot>
                      <tr>
                        <th colspan='4' id='vat_desc' style='text-align: right'>Total Labor</th>
                  ...
                  <div style="clear:both; height:15px;"></div>
                                    ...
                                    <button type="submit" name="labor" id="submit_new1" class="btn btn-primary" style="float:right; margin-top:2px; margin-right:10px"><i class='fa fa-save'></i> &nbsp;Submit</button>
  ...
  for (i = 1; i <= length; i++){
      add_function(i);
                    ...
                    <?php
                        if($bom->get_labor($_GET['bom']) > 0){
                    ?>
                        var last_id = '<?php echo $bom->get_labor($_GET['bom'])+1; ?>';
                    <?php    
                        }
                        else{
                    ?>
...
function multiply(id){
  ...
  var days_ = ($("#days"+id).val()).replace(/\,/g,'');
  var rate_ = ($("#rate"+id).val()).replace(/\,/g,'');

  var quan = parseFloat(quan_);
  var days = parseFloat(days_);
...
if (isset($_GET['success'])) {
  ?>
    swal("Success", "Successfully recorded labor.", "success");
    history.pushState(null, null, 'labor?bom=<?php echo $_GET['bom']; ?>');
<?php
}
?>
</script>
