  ...
  <div class="content-wrapper">
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">
              <a href='javascript:void(0);' data-href='view_account.php' id='addAccount'><button type='button' class='btn btn-success'><i class='fa fa-plus'></i> &nbsp;Add New Record</button></a>
              </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <thead>
                <tr>
                  <th style='width:80%'>Account Title</th>
...
if (isset($_GET['success'])) {
  ?>
    ...
    history.pushState(null, null, 'account_title');
<?php
...
$(document).ready(function(){
  $('#example1 tbody').on('click', '.editAccount', function () {
