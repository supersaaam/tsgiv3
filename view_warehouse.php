...
@keyframes spin {
  ...
  100% { transform: rotate(360deg); }
                    ...
                    <form action='models/warehouse_model.php?id=<?php echo $id; ?>' method='post'>  
                  ...
                  <div class="form-group">
                    ...
                    <textarea required style='resize:none' maxlength='200' name="location" class="form-control" placeholder='Type input here...'><?php echo $location; ?></textarea>
                  </div>
	    ...
	    if (str.length == 0) { 
	        ...
	        xmlhttp.onreadystatechange = function() {
	            if (this.readyState == 4 && this.status == 200) {
					...
					if(this.responseText == " &nbsp; Warehouse name already exists! "){
	        ...
	        xmlhttp.open("GET", "models/validate_ajax.php?q_whname=" + str, true);
	        xmlhttp.send();
	    }
	}
