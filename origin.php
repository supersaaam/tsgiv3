  ...
  <div class="content-wrapper">
      ...
      <h1>
        ...
        <small>Records Management</small>
          ...
          <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Origin Records</li>
            </ol>
    </section>
    ...
    <div class="box">
            <div class="box-header">
              <h3 class="box-title">
              <a href='javascript:void(0);' data-href='view_origin.php' id='addOrigin'><button type='button' class='btn btn-success'><i class='fa fa-plus'></i> &nbsp;Add New Record</button></a>
              </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
$(document).ready(function(){
  $('#example1 tbody').on('click', '.editOrigin', function () {
   ...
   $('#example1 tbody').on('click', '.delete', function () {
      ...
      swal({
        title: "Are you sure?",
        text: "You are about to delete this origin. Proceed?",
        type: "warning",
      ...
      function(isConfirm) {
        if (isConfirm) {
          window.location.href = 'models/origin_model.php?id_delete='+id;
        } else {
          swal.close();
        }
      });
