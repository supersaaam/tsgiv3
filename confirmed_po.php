...
include 'models/po_supp_att_model.php';
...
?>
  ...
  <div class="content-wrapper">
      ...
      <div class="box-body">
              ...
              <form role="form" action="models/so_aed.php" method="post" id="">
                    ...
                    <div class="form-group" style='float:left; width:48%; margin-right:2%'>
                      ...
                      <input required name="q_num" value='<?php echo $po_num; ?>' class="form-control" readonly>
                    </div>
                    
                    <div class="form-group" style='float:left; width:48%; margin-left:2%'>
                      <label>Sales Order Reference No.</label>
                      <input required name="po" value='<?php echo $po->so_ref; ?>' readonly class="form-control">
                    </div>

                   <div class="form-group">
                      <label>Customer </label>
                      <input type='text' required name="customer" id='customer' readonly class="form-control" value='<?php echo $po->brand; ?>' placeholder="Please input customer name ...">
                    </div>
                    
                    <div class="form-group">
                      <label>Contact Person </label>
                      <input type='text' required name="" id='' readonly class="form-control" value='<?php echo $po->cperson; ?>' placeholder="">
                    </div>
                    ...
                    <div class="col-md-6" style="float:left; padding-right: 30px">
                        ...
                        <div class="form-group" style='float: left; width: 48%; margin-right: 2%'>
                      <label>Date</label>
                      <input name="date" type='date' value='<?php echo $po->date; ?>' readonly class="form-control" required>
                    </div>

		            <div class="form-group" style='float: left; width: 48%; margin-left: 2%'>
                      <label>Terms of Payment</label>
                      <input list="terms_list" required name="terms" value='<?php echo $po->terms; ?>' readonly class="form-control" placeholder="Please input terms ...">
                    </div>
                    
                    <div class="form-group" style='float: left; width: 48%; margin-right: 2%'>
                      <label>Ship Via</label>
                      <input name="" type='text' value='<?php echo $po->shipment; ?>' readonly class="form-control" required>
                    </div>
                    
                    <div class="form-group" style='float: left; width: 48%; margin-left: 2%'>
                      <label>Incoterms</label>
                      <input name="" type='text' value='<?php echo $po->incoterms; ?>' readonly class="form-control" required>
                    </div>
                    
                    <div class="form-group">
                      <label>Note</label>
                      <textarea required name="" id='' readonly class="form-control" rows='3' style='resize:none'><?php echo $po->note; ?></textarea>
                    </div>
                  ...
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <tbody id="trans_table">
                      <?php
                      	$po->show_bd_po($po_num);
                      ?>
                    </tbody>
                    <tfoot>
                      <tr>
                        <th colspan='4' style='text-align: right'>Total Sales (VAT Inclusive)</th>
                        <td colspan='1'><input type="text" name="total_price" id='total_price' style="text-align:left; background-color:transparent; border:transparent" class="form-control" readonly value='<?php echo $po->currency.' '.number_format($po->amount,2); ?>'></td>
                      </tr>
                      <tr>
                        <th colspan='4' style='text-align: right'>Less: A/R</th>
                        <td colspan='1'><input type="text" name="" id='' style="text-align:left; background-color:transparent; border:transparent" class="form-control" readonly value='<?php echo $po->currency.' '.number_format($po->ar,2); ?>'></td>
                      </tr>
                      
                      <tr>
                        <th colspan='4' style='text-align: right'>Total Amount to Pay:</th>
                        <?php
                        $topay = $po->amount - $po->ar;
                        ...
                        <td colspan='1'><input type="text" name="" id='' style="text-align:left; background-color:transparent; border:transparent" class="form-control" readonly value='<?php echo $po->currency.' '.number_format($topay,2); ?>'></td>
                      </tr>
                    </tfoot>
                  </table>
              ...
              <a href='javascript:void(0);' data-href='view_costing.php?po=<?php echo $po_num;?>' id='costing'><button type='button' class='btn btn-success' style='float:right; margin-right: 20px; margin-bottom: 20px; margin-top: 20px'><i class='fa fa-eye'></i>&nbsp;&nbsp;View Costing</button></a>
    ...
    <form method='post' id="form" action='models/po_supp_att_model.php' enctype='multipart/form-data'>
     
    <input type="hidden" value="<?php echo $po_num; ?>" name="id">
...
if (isset($_GET['uploaded'])) {
  ?>
    ...
    history.pushState(null, null, 'confirmed_po?po=<?php echo $_GET['po']; ?>');
<?php
}
...
elseif (isset($_GET['cost'])) {
  ?>
    swal("Success", "Costing successfully recorded.", "success");
    history.pushState(null, null, 'confirmed_po?po=<?php echo $_GET['po']; ?>');
<?php
}
