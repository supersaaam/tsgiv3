...
<body>
                ...
                <table id="example2" style='width:100%' >
                  ...
                  <thead>
                    ...
                    <tr>
                      <th colspan='3' style='width:70%; font-size: 100%;'>Debit to: <label style='font-weight:normal'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $cr->company; ?></label></th>
                      <th colspan='3' style='width:30%; font-size: 100%;'>Debit Date: <label style='font-weight:normal'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo date_format(date_create($cr->date), "F j, Y"); ?></label></th>
                    </tr>
                    <tr>
