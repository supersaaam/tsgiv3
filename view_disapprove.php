...
?>
                ...
                <form action='models/sales_order_model.php?id=<?php echo $so; ?>' method='post'>  
                  ...
                  <button type="submit" name='disapprove' id='submit' class="btn btn-success" style="float:right; margin-top:2px; margin-right:10px"><i class='fa fa-save'></i> &nbsp;Save Details</button>
                   </form>