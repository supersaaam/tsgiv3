      ...
      <div class="box-body">
              ...
              <!--START OF FIRST TABLE-->    
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    <?php
                      if($bom->get_permit($_GET['bom']) > 0){
                            $bom->show_permit($_GET['bom']);   
                        }
                        else{
                    ?>
                    ...
                    <tfoot>
                      <tr>
                        <th colspan='3' id='vat_desc' style='text-align: right'>Total Structure and Permits</th>
                  ...
                  <div style="clear:both; height:15px;"></div>
                                    ...
                                    <button type="submit" name="permit" id="submit_new1" class="btn btn-primary" style="float:right; margin-top:2px; margin-right:10px"><i class='fa fa-save'></i> &nbsp;Submit</button>
  ...
  for (i = 1; i <= length; i++){
      add_function(i);
                    ...
                    <?php
                        if($bom->get_permit($_GET['bom']) > 0){
                    ?>
                        var last_id = '<?php echo $bom->get_permit($_GET['bom'])+1; ?>';
                    <?php    
                        }
                        else{
                    ?>
...
if (isset($_GET['success'])) {
  ?>
    swal("Success", "Successfully recorded structure and permits.", "success");
    history.pushState(null, null, 'permit?bom=<?php echo $_GET['bom']; ?>');
<?php
}
?>
</script>
