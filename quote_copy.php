      ...
      <div class="box-body">
              ...
              <form role="form" action="models/quote_aed.php" method="post" id="">
                    ...
                    <div class="form-group">
                      ...
                      <input required name="q_num" value='<?php echo $nxt_id; ?>' class="form-control" readonly>
                    </div>

                   <div class="form-group">
                      <label>Customer </label>
                      <input type='text' required name="customer" id='customer' class="form-control" value='<?php echo $q->company; ?>' placeholder="Please input customer name ...">
                    </div>
                  ...
                  <table id="example2" class="table table-bordered table-striped">
                    ...
                    ?>
                      ...
                      <tr id='vat'>
                        ...
                        <td colspan='2'><input type="text" id='vat' style="text-align:left; background-color:transparent; border:transparent" class="form-control" readonly value='0.00'></td>
                      </tr>
                      <tr id='vat1'>
...
if (isset($_GET['success'])) {
  ?>
    ...
    history.pushState(null, null, 'quote_copy');
<?php
}
?>
</script>
