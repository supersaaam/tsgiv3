                    ...
                    <div class="form-group" style='float:left; width:48%; margin-right:2%'>
                      ...
                      <input type='hidden' name='po_numbers' id='po_numbers'>
                    ...
                    <button type='submit' name='costing_multiple' class='btn btn-success' style='float:right; margin-right: 10px; margin-bottom: 10px; margin-top: 10px'><i class='fa fa-save'></i>&nbsp;&nbsp;Submit</button>
